...
- Next focus: convert `/routes/helpers` middleware (`api.js`, `render.js`, `flash.js`) to ESM so `app.mjs` can drop its remaining `createRequire` bridge for the request pipeline.
