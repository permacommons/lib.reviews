...
- Next focus: migrate remaining high-churn route handlers to ESM, with `/routes/pages.js` and `/routes/blog-posts.js` up next to keep DAL-facing logic consistent.
