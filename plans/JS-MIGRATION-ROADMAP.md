...
- Next focus: migrate remaining high-churn route handlers to ESM, with `/routes/uploads.js` and `/routes/apitest.js` up next to keep DAL-facing logic consistent.
