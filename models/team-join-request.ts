...
type TeamJoinRequestInstance = ModelInstance<TeamJoinRequestRecord, TeamJoinRequestVirtual> &
  Record<string, any>;
type TeamJoinRequestModel = ModelConstructor<
  TeamJoinRequestRecord,
  TeamJoinRequestVirtual,
 ...
 */
export async function initializeTeamJoinRequestModel(
  dalInstance: Record<string, any> | null = null
): Promise<TeamJoinRequestModel | null> {
  ...
  try {
    ...
    if (!isNew) return TeamJoinRequest;
...
const TeamJoinRequestHandle = createAutoModelHandle<
  TeamJoinRequestRecord,
  TeamJoinRequestVirtual,
  TeamJoinRequestInstance
>('team_join_requests', initializeTeamJoinRequestModel);
