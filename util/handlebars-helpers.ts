...
hbs.registerHelper(
  'mlString',
  function (str: unknown, addLanguageSpan: boolean | HelperOptions, options?: HelperOptions) {
    // hbs passes options object in as last parameter
    if (arguments.length == 2) {
      options = addLanguageSpan as HelperOptions;
      addLanguageSpan = true;
    } else if (addLanguageSpan === undefined) addLanguageSpan = true;
...
hbs.registerHelper(
  'renderFilePreview',
  function (file: { mimeType: string; name: string }, restricted: boolean) {
